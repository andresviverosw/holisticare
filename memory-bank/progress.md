...
- QA sign-off for Sprint 11 R1-UI panels.
...
- [2026-07-16] Development: Sprint 11 UI execution — risk flags, clinician-proxy diary, analytics, sessions on Dashboard (Vitest 36 passing).
