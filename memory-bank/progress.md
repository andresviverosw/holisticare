...
- **Final delivery (R-final):** US-PRIV-001, US-OPS-SPA-HOST + DEPLOY-01 (public hybrid deploy), Phase 1/3 doc closeout, RAG eval report, public demo + feedback package (`docs/final-delivery-plan.md`).
...
- [2026-07-25] Planning Agent: Locked D1–D4 — D2 = public hybrid deploy (second-delivery approach); promoted US-OPS-SPA-HOST + DEPLOY-01 to Must; plan status Approved / Sprint 16 ready for dev.
